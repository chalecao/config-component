...
function useFormalWeb(initialValues, config) {
    ...
    var getFieldProps = react_1.useCallback(function (field) { return (__assign({}, formal.getFieldProps(field), { name: field, id: field, onChange: function (e) {
    ...
    var getResetButtonProps = react_1.useCallback(function () { return (__assign({}, formal.getResetButtonProps(), { type: 'button', onClick: function () {
            formal.reset();
        } })); }, [formal]);
    var getSubmitButtonProps = react_1.useCallback(function () { return (__assign({}, formal.getSubmitButtonProps(), { type: 'submit' })); }, [formal]);
