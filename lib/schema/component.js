...
function ConfigComponent(_a) {
    var uiConfig = _a.uiConfig, initialValues = _a.initialValues, schema = _a.schema, _b = _a.componentSet, componentSet = _b === void 0 ? {} : _b;
    // console.log('ConfigComponent', initialValues)
