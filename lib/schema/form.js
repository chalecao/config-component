...
function ConfigForm(_a) {
    var any = _a.uiConfig, any = _a.initialValues, any = _a.schema, any = _a.onSubmit, _b = _a.componentSet, componentSet = _b === void 0 ? {} : _b;
    var formal = formal_web_1.default(initialValues, {
        schema: schema,
        onSubmit: onSubmit
    });
    var Form = componentSet.Form || constant_1.DefaultForm;
