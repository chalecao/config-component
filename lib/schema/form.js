...
function ConfigForm(_a) {
    const {uiConfig} = _a; const {initialValues} = _a; const {schema} = _a; const {onSubmit} = _a; const _b = _a.componentSet; const componentSet = _b === void 0 ? {} : _b
    const formal = formal_web_1.default(initialValues, {
        schema,
        onSubmit,
    })
    const Form = componentSet.Form || constant_1.DefaultForm
