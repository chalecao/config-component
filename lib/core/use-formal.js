...
function useFormal(initialValues, _a) {
    ...
    var validate = react_1.useCallback(function () {
        if (!schema) {
            throw new Error('You cannot call validate if you have not provided any schema.');
        }
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        isAsync = utils_1.schemaHasAsyncValidation(schema, values);
                        _a.label = 1;
                    case 1:
                        ...
                        return [4 /*yield*/, schema[validationMethod](values, { abortEarly: false })];
                    case 2:
                        _a.sent();
                        resolve();
                        return [3 /*break*/, 5];
