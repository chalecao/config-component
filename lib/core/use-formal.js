...
function useFormal(initialValues, _a) {
    ...
    var change = react_1.useCallback(function (field, value) {
        setValues(function (prevValues) {
            var _a;
            return (__assign({}, prevValues, (_a = {}, _a[field] = value, _a)));
        });
    }, []);
    ...
    react_1.useEffect(function () {
        setValues(function (prevValues) { return (__assign({}, prevValues, initialValues)); });
        clearErrors();
    ...
    var validate = react_1.useCallback(function (val) {
        ...
        if (val) {
            checkValues = __assign({}, values, val);
        }
    ...
    var reset = react_1.useCallback(function (key) {
        if (key) {
            var _values_1 = __assign({}, values);
            key.forEach(function (kk) {
                _values_1[kk] = lastValues[kk];
            });
            setValues(_values_1);
        }
        else {
    ...
    var submit = react_1.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error_2 = _b.sent();
                    console.log('submit validate error:', error_2);
